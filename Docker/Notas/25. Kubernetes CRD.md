...
• e.g. Databases, monitoring tools, backups, and custom ingresses Higher Deployment Abstractions
...
Copy customresourcedefinition/shirt-resource-definition.yaml to clipboard

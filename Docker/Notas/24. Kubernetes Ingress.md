...
Copy service/networking/minimal-ingress.yaml to clipboard
...
Copy service/networking/ingress-resource-backend.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
...
Copy service/networking/ingress-wildcard-host.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
...
Copy service/networking/external-lb.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: IngressClass
metadata:
  name: external-lb
...
Copy service/networking/default-ingressclass.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: IngressClass
metadata:
  labels:
...
Copy service/networking/test-ingress.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
  name: test-ingress
...
Copy service/networking/simple-fanout-example.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
...
Copy service/networking/name-virtual-host-ingress.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
...
Copy service/networking/tls-example-ingress.yaml to clipboard
apiVersion: networking.k8s.io/v1
kind: Ingress
metadata:
